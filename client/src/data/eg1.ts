...
export const EG1_SET: AlgSet = {
  ...
  cases: [
    // Anti-Sune
    { id: 'EG1-AS-1', name: 'EG1 AS 1', group: 'Anti-Sune', moves: "y U2 B U' R2 F2 U' F", probability: '—', diagramPrefix: 'x2', alts: ["y R' F R2 U R' F' U' R U' R'", "y U' L' U' L U' F' L' U L2 F L'", "y L' U L2 F L' F' U' L F' L'"] },
